...
const CASES_DATA = [
  {
    id: '01', slug: 'miles-one',
    codename: 'OPERATION: MILES ONE',
    title: 'Agentic AI & App Architecture',
    image: '/cases/miles.jpg',
    metrics: ['+40% Qualified Leads', 'Zero-Touch Resolution'],
    description: 'Architected a full-scale AI Agentic framework using n8n and PostgreSQL. Replaced traditional manual lead qualification with a Goal-Oriented RAG system capable of booking webinars and retrieving contextual LMS data in real-time.',
    accent: '#dc2626',
    gradient: 'linear-gradient(135deg, #1a0a0a 0%, #2a1218 30%, #1a0f14 60%, #0d0a0f 100%)',
  },
  {
    id: '02', slug: 'almabetter',
    codename: 'OPERATION: ALMABETTER',
    title: 'Operational Debt Eradication',
    image: '/cases/alma.jpg',
    metrics: ['-80% Dev Errors', '9.1 Peak CSAT'],
    description: 'Dropped into a chaotic engineering workflow. Completely re-engineered sprint cycles, deployed an n8n ELT layer for a productized ticketing system, and accelerated content readiness by two full weeks.',
    accent: '#3b82f6',
  ...
  },
  {
    ...
    description: 'Analyzed deep telemetry and behavioral drop-off data to identify structural friction points. Translated these psychological insights into digital interventions that drove massive cohort completion rates.',
    accent: '#10b981',
