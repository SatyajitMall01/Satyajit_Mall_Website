...
const BentoCard = ({ tag, title, body, delay = 0, span = 1, children }) => {
  ...
  return (
    ...
    >
      ...
      {children ? children : (
        <>
          <span style={{ fontFamily: TELE, fontSize: 9, color: A, letterSpacing: '0.35em', textTransform: 'uppercase', display: 'block', marginBottom: 12 }}>
            {tag}
          </span>
          <h3 style={{ fontFamily: SWISS, fontSize: 19, fontWeight: 700, color: '#FFFFFF', lineHeight: 1.2, marginBottom: 12 }}>
            {title}
          </h3>
          <p style={{ fontFamily: SWISS, fontSize: 14, fontWeight: 300, color: '#E5E7EB', lineHeight: 1.85 }}>
            {body}
          </p>
        </>
      )}
...
const MetricPill = ({ value, suffix, label, delay = 0 }) => {
  ...
  return (
    ...
    >
      <span style={{ fontFamily: SWISS, fontSize: 'clamp(26px, 3.5vw, 36px)', fontWeight: 800, color: '#FFFFFF', letterSpacing: '-0.03em', display: 'block', lineHeight: 1 }}>
        <Counter value={value} suffix={suffix} />
      </span>
      <span style={{ fontFamily: TELE, fontSize: 9, color: A, letterSpacing: '0.25em', textTransform: 'uppercase', marginTop: 8, display: 'block' }}>
        {label}
      </span>
      <motion.div
...
const NetworkBackground = () => {
  ...
  const nodes = useRef(Array.from({ length: 20 }, () => ({ x: Math.random() * 100, y: Math.random() * 100, size: Math.random() * 3 + 1 }))).current;
  ...
  return (
    <div ref={ref} className="absolute inset-0 overflow-hidden pointer-events-none" style={{ opacity: 0.3 }}>
      <svg width="100%" height="100%" viewBox="0 0 100 100" preserveAspectRatio="none">
        ...
        {nodes.map((n, i) => (
          <motion.circle key={`n-${i}`} cx={n.x} cy={n.y} r={n.size * 0.15}
            fill={i % 3 === 0 ? A : 'rgba(255,255,255,0.2)'}
            initial={{ opacity: 0 }} animate={inView ? { opacity: [0, 0.6, 0.3] } : {}}
    ...
    <div className="relative w-full" style={{ background: '#050505' }}>
      ...
      <section className="relative z-10" style={{ padding: '100px 24px 40px' }}>
        ...
        <motion.div className="max-w-6xl mx-auto text-center" style={{ y: headerY, opacity: headerOpacity }}>
          ...
          <motion.div className="mt-12" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 1.2, duration: 0.8 }}>
        ...
        <div className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-12 gap-12">
          <div className="md:col-span-4">
            <motion.div initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true, margin: '-60px' }}>
              <span style={{ fontFamily: TELE, fontSize: 10, color: A, letterSpacing: '0.3em', textTransform: 'uppercase' }}>Strategic Intent</span>
      ...
      <section className="relative z-10" style={{ padding: '40px 24px 80px' }}>
        <div className="max-w-6xl mx-auto">
          ...
          >[ The Command Console ]</motion.p>

          <div className="grid grid-cols-1 md:grid-cols-5 gap-5 mb-5">
            <div className="md:col-span-3" style={{ minHeight: 360 }}>
              <BentoCard delay={0} span={1}><ScrollTerminal /></BentoCard>
            </div>
            <div className="md:col-span-2">
              <BentoCard tag="Protocol 01" title="The tk= Token"
          ...
          <div className="grid grid-cols-1 md:grid-cols-5 gap-5 mb-5">
            <div className="md:col-span-2">
              <BentoCard tag="Protocol 02" title="ROAS/ROCS Financial Loop"
            ...
            <div className="md:col-span-3" style={{ minHeight: 300 }}>
              <BentoCard delay={0.2} span={1}>
                <div style={{ padding: '0' }}><AttributionViz /></div>
              </BentoCard>
            </div>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            <BentoCard tag="Protocol 03" title="U-Shaped Attribution Model"
              ...
              delay={0.25} />
            <BentoCard tag="Protocol 04" title="Intent-Based Routing"
      ...
      <section className="relative z-10" style={{ padding: '40px 24px 120px', textAlign: 'center' }}>
        ...
        <Link to="/cases/agentic-voice-qualification"
          style={{ display: 'inline-flex', alignItems: 'center', gap: 12, fontFamily: TELE, fontSize: 12, fontWeight: 600, color: A, letterSpacing: '0.2em', textTransform: 'uppercase', padding: '14px 32px', border: `1px solid ${A}35`, borderRadius: 8, background: `${A}08`, textDecoration: 'none', transition: 'all 0.3s ease' }}
...
export default DesktopCaseEngage;
